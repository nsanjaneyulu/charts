...
@Component({
  selector: 'app-overall-sentiment-score',
  standalone: true,
  imports: [CardModule],
  templateUrl: './overall-sentiment-score.component.html',
  styleUrl: './overall-sentiment-score.component.scss'
})
export class OverallSentimentScoreComponent implements OnInit, OnDestroy {
